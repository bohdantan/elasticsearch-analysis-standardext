...
public class ExtensibleStandardTokenizerFactory extends AbstractTokenizerFactory {
    ...
    @Inject
    public ExtensibleStandardTokenizerFactory(Index index, IndexSettingsService indexSettingsService, @Assisted String name, @Assisted Settings settings) {
    ...
    public Tokenizer create() {
        if (version.onOrAfter(Version.LUCENE_4_7_0)) {
            ExtensibleStandardTokenizer tokenizer = new ExtensibleStandardTokenizer();
